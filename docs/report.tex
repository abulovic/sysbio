...
\subsection{Results}
\label{sec:results}
\subsubsection{Parameter inference for Lotka-Volterra model}
\subsubsection{Parameter inference for other model}
...
%second part
\subsection{Parameter inferecence and Sensitivity analysis}
%sensitivity with PCA on information from last population of smc blah blah
\subsection{Effect of global dynamics on parameter inference}
